        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsOpenning = table.Column<bool>(type: "bit", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RestaurantCuisineTypeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RestaurantId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurantCuisineType", x => x.RestaurantCuisineTypeId);
                    table.ForeignKey(
                        name: "FK_RestaurantCuisineType_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RestaurantCuisineType_cuisineTypes_CuisineTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodReview", x => x.FoodReviewId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestaurantCuisineType_CuisineTypeId",
                table: "RestaurantCuisineType",
                column: "CuisineTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_RestaurantCuisineType_RestaurantId",
                table: "RestaurantCuisineType",
                column: "RestaurantId");
